...
// void des_encode_var(unsigned char *des_key, unsigned char *dest,
// unsigned char *dest_len, unsigned char *src, unsigned char src_len);
final DesFlutterFuc nativeDesEncode =
    desLib.lookup<NativeFunction<DesNativeFuc>>("des_encode_var").asFunction();

// void des_decode_var(unsigned char *des_key, unsigned char *dest,
// unsigned char *dest_len, unsigned char *src, unsigned char src_len);
...
Pointer<Uint8> _bytesToPointer(Uint8List bytes) {
  ...
  final result = malloc.allocate<Uint8>(length);
...
Uint8List desEncode(Uint8List key, Uint8List input) {
  ...
  final result = malloc.allocate<Uint8>(length);
  final resultLen = malloc.allocate<Uint8>(1);
